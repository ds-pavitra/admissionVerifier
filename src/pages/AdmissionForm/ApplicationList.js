    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs title="Application Management" breadcrumbItems={breadcrumbItems} />
                    <Row>
                        <Col lg="12">
                            <Card>
                                <CardBody>
            ...
            <Modal isOpen={modalOpen} toggle={closeModal} size="xl">
                ...
                <ModalBody>
                    {selectedApplication && <ViewApplication application={selectedApplication}  fetchlist={fetchApplications} toggle={closeModal} verificationStatus={applicationStatus} verifyType="verify" />}
                </ModalBody>
            </Modal>
        </React.Fragment>
    );
